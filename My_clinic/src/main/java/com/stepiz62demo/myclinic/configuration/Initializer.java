...
import com.stepiz62demo.myclinic.configuration.Initializer;
...
public class Initializer  extends AbstractAnnotationConfigDispatcherServletInitializer  {
	...
	private void buildMenu(MenuConfig menuConfig) {
		menuConfig.addItem("patient", null);
		menuConfig.addItem("customer", null);
		menuConfig.addItem("appuser", null);
 	}
